...
if ($ADMIN->fulltree) {
    ...
    if (!function_exists('ldap_connect')) {
        $notify = new \core\output\notification(get_string('auth_ldapup1_noextension', 'auth_ldapup1'),
            \core\output\notification::NOTIFY_WARNING);
        $settings->add(new admin_setting_heading('auth_ldapup1_noextension', '', $OUTPUT->render($notify)));
    } else {
        ...
        $settings->add(new admin_setting_heading('auth_ldapup1/pluginname', '',
                new lang_string('auth_ldapup1description', 'auth_ldapup1')));

        // LDAP server settings.
        $settings->add(new admin_setting_heading('auth_ldapup1/ldapserversettings',
                new lang_string('auth_ldapup1_server_settings', 'auth_ldapup1'), ''));

        // Host.
        $settings->add(new admin_setting_configtext('auth_ldapup1/host_url',
                get_string('auth_ldapup1_host_url_key', 'auth_ldapup1'),
                get_string('auth_ldapup1_host_url', 'auth_ldapup1'), '', PARAM_RAW_TRIMMED));

        // Version.
        $versions = [];
        $versions[2] = '2';
        $versions[3] = '3';
        $settings->add(new admin_setting_configselect('auth_ldapup1/ldap_version',
                new lang_string('auth_ldapup1_version_key', 'auth_ldapup1'),
                new lang_string('auth_ldapup1_version', 'auth_ldapup1'), 3, $versions));
        ...
        **/
        ...
        // Encoding.
        $settings->add(new admin_setting_configtext('auth_ldapup1/ldapencoding',
                get_string('auth_ldapup1_ldap_encoding_key', 'auth_ldapup1'),
                get_string('auth_ldapup1_ldap_encoding', 'auth_ldapup1'), 'utf-8', PARAM_RAW_TRIMMED));
        ...
        **/
        ...
        // Bind settings.
        $settings->add(new admin_setting_heading('auth_ldapup1/ldapbindsettings',
                new lang_string('auth_ldapup1_bind_settings', 'auth_ldapup1'), ''));

        // Store Password in DB.
        $settings->add(new admin_setting_configselect('auth_ldapup1/preventpassindb',
                new lang_string('auth_ldapup1_preventpassindb_key', 'auth_ldapup1'),
                new lang_string('auth_ldapup1_preventpassindb', 'auth_ldapup1'), 0 , $yesno));

        // User ID.
        $settings->add(new admin_setting_configtext('auth_ldapup1/bind_dn',
                get_string('auth_ldapup1_bind_dn_key', 'auth_ldapup1'),
                get_string('auth_ldapup1_bind_dn', 'auth_ldapup1'), '', PARAM_RAW_TRIMMED));

        // Password.
        $settings->add(new admin_setting_configpasswordunmask('auth_ldapup1/bind_pw',
                get_string('auth_ldapup1_bind_pw_key', 'auth_ldapup1'),
                get_string('auth_ldapup1_bind_pw', 'auth_ldapup1'), ''));

        // User Lookup settings.
        $settings->add(new admin_setting_heading('auth_ldapup1/ldapuserlookup',
                new lang_string('auth_ldapup1_user_settings', 'auth_ldapup1'), ''));

        // User Type.
        $settings->add(new admin_setting_configselect('auth_ldapup1/user_type',
                new lang_string('auth_ldapup1_user_type_key', 'auth_ldapup1'),
                new lang_string('auth_ldapup1_user_type', 'auth_ldapup1'), 'default', ldap_supported_usertypes()));

        // Contexts.
        $settings->add(new auth_ldap_admin_setting_special_contexts_configtext('auth_ldapup1/contexts',
                get_string('auth_ldapup1_contexts_key', 'auth_ldapup1'),
                get_string('auth_ldapup1_contexts', 'auth_ldapup1'), '', PARAM_RAW_TRIMMED));

        // Search subcontexts.
        $settings->add(new admin_setting_configselect('auth_ldapup1/search_sub',
                new lang_string('auth_ldapup1_search_sub_key', 'auth_ldapup1'),
                new lang_string('auth_ldapup1_search_sub', 'auth_ldapup1'), 0 , $yesno));
        ...
        $settings->add(new admin_setting_configselect('auth_ldapup1/opt_deref',
                new lang_string('auth_ldapup1_opt_deref_key', 'auth_ldapup1'),
                new lang_string('auth_ldapup1_opt_deref', 'auth_ldapup1'), LDAP_DEREF_NEVER , $optderef));

        // User attribute.
        $settings->add(new auth_ldap_admin_setting_special_lowercase_configtext('auth_ldapup1/user_attribute',
                get_string('auth_ldapup1_user_attribute_key', 'auth_ldapup1'),
                get_string('auth_ldapup1_user_attribute', 'auth_ldapup1'), '', PARAM_RAW));
        ...
        **/
        // Object class.
        $settings->add(new admin_setting_configtext('auth_ldapup1/objectclass',
                get_string('auth_ldapup1_objectclass_key', 'auth_ldapup1'),
                get_string('auth_ldapup1_objectclass', 'auth_ldapup1'), '', PARAM_RAW_TRIMMED));

        
        //champ propre à auth_ldapup1
        //synchronisation
        $settings->add(new admin_setting_heading('auth_ldapup1/synchronisation',
                new lang_string('auth_sync_script', 'auth'), ''));
        $settings->add(new admin_setting_configtext('auth_ldapup1/sync_condition',
                get_string('sync_condition_key', 'auth_ldapup1'),
                get_string('sync_condition', 'auth_ldapup1'), '', PARAM_RAW_TRIMMED));
...
**/                
    ...
    $authplugin = get_auth_plugin('ldapup1');
